...
All rows remain `audited`. Existing Server Actions, queries, schemas, Prisma
models, or GitHub Issues do not make an HTTP contract `contract defined`.
Contract methods, paths, DTOs, errors, and sensitive-field allowlists remain for
T015-T019 and the later contract-specific Issues.
...
Issue numbers below refer to approved Issues that already exist in GitHub. Issue
#18 does not create, close, or assign any Issue. T014 (#19) remains the required
Arthur review of frontend-owned gaps after T008-T013.
